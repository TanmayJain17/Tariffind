<p align="center">
  <img src="docs/TariffShield-logo.png" alt="TariffShield" width="120" />
</p>
...
| Service | Platform | One-liner |
|---------|----------|-----------|
| Backend | Railway | Push to GitHub → connect repo → add env vars → deploy |
| Frontend | Vercel | `npx vercel` from frontend directory |
